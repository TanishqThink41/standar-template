...
export function FileCard({ file, index, onAction }: FileCardProps) {
  return (
    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
      ...
      <td className="py-3 px-4">
        <Button 
          variant="ghost" 
          className="text-gray-400 hover:text-gray-800 hover:bg-gray-50 p-1"
          onClick={() => onAction && onAction(file)}
        >
          <svg 
